    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                <div class="fixed top-6 left-1/2 -translate-x-1/2 bg-green-600 text-white px-8 py-4 rounded-2xl shadow-2xl flex items-center gap-3 z-100 border border-green-400">
        ...
        <div className="min-h-screen flex flex-col items-center bg-black ">
            <header >
                <div className="p-2 mt-5 ">
                    <div className="p-1 ">
                        <div onClick={() => navigate('/signin')} className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-700 transition-all duration-200 cursor-pointer">
                    ...
                    <div className="p-2 pl-5  ">
                        ...
                        <form onSubmit={handleSubmit} className="mt-2" method="POST">
                            ...
                            <div className="mt-5">
                                ...
                                <button type="button" onClick={() => navigate('/signin')} className="w-full  mx-auto mt-3 py-3 block rounded-full border cursor-pointer border-[#36393F] text-[#E4E6EB] text-sm font-semibold bg-transparent hover:bg-[#1A1A1D] active:scale-[0.98] transition-all duration-200">
