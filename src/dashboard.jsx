...
function dashboard() {
    ...
    return (
        ...
        <div className=" min-h-screen block md:flex  bg-black">
            ...
            {/* <div className="p-5 md:hidden block relative   ">
                ...
                <input type="search" className="bg-[#25292E] rounded-2xl p-2 placeholder-white placeholder:p-2" placeholder="Search" >
            ...
            <div className="flex-1 max-w-150 mx-auto p-5 xl:ml-62.5 ">
                ...
                {/* STORIES */}
                <div className="h-25 border-gray-700 flex items-center gap-4 px-4 ">

                    <img src={flower} className="w-20 h-20 rounded-full"></img>
                        ...
                        <div className="block">
                            <div >
                                ...
                                <div class="caption" className="block">
                                    <a href="" className="text-white text-sm font-semibold ml-2 ">adya_5711</a>
